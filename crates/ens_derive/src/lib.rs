...
use ens_macro_utils::{derive_label, EnsManifest};
...
/// Ens's [derive] macro for convenience.
///
/// # Example
///
/// ## Tuple Structs
...
pub fn ens_main(attr: TokenStream, item: TokenStream) -> TokenStream {
    ens_main::ens_main(attr, item)
}
...
pub fn derive_app_label(input: TokenStream) -> TokenStream {
    ...
    let mut trait_path = EnsManifest::default().get_path("ens_app");
