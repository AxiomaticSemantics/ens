...
pub use ens_macros::{ScheduleLabel, SystemSet};
use ens_utils::define_label;
use ens_utils::intern::Interned;
...
#[cfg(test)]
mod tests {
    use crate::{access::ResMut, schedule::Schedule, system::Resource};

    use super::*;

    #[test]
    fn test_schedule_label() {
        use crate::{self as ens, world::World};
