...
impl<'w, 's, E: Event> EventReader<'w, 's, E> {
    ...
    ///     }
    /// }
    /// # ens::system::assert_is_system(play_collision_sound);
    /// ```
    pub fn is_empty(&self) -> bool {
...
/// ```
/// use ens::prelude::*;
/// use ens::event::{Event, Events, ManualEventReader};
///
...
/// }
///
/// # ens::system::assert_is_system(send_and_receive_manual_event_reader);
/// ```
#[derive(Debug)]
